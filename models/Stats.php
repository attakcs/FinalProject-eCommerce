...
class Stats extends Model{
    ...
    public function LoyalCustomers(Array $params=[]){
        ...
        if($rows === false){
            return new \Result(
                null,
                'Failed to get top loyal customers stats',
                'error',
                ''
            );
        }
    ...
    function MonthlyIncome(Array $params=[]){
        ...
        if($rows === false){
            return new \Result(
                null,
                'Failed to get top monthly income stats',
                'error',
                ''
            );
        }
    ...
    function MonthlyInvoices(Array $params=[]){
        ...
        if($rows === false){
            return new \Result(
                null,
                'Failed to get top monthly invoice stats',
                'error',
                ''
            );
        }
