<h3 class="divider">Question Manager</h3>
...
<section class="data-editor">
    <form id="frmEditor">
        ...
        <p>
            <label for="question_id">ID</label>
            <input type="number" id="question_id" name="question_id" readonly>
        </p>
        <p>
...
<script>
    ...
    function OperationHandler(e){
        ...
        switch(e.target.id){                      
            case 'btnUpdate':
                ...
                FillForm(GetCellValue(tblData, SelectedRow.rowIndex-1, 'question_id'));
            ...
            case 'frmEditor':
                ...
                if(currentOper == 'Delete'){
                    data = {question_id:$('#question_id').value};
                }
    ...
    function FillForm(id){
        Ajax('POST', '/api/Question/Read/' + id,
            null,
            function(resp){
                if(ErrorInResponse(resp)){
                    return false;
                ...
                let r = resp.data[0];
                $('#question_id').value =   r.question_id;
